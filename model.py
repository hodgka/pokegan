...
from ops import batch_norm, lrelu, linear, conv2d, deconv2d, concat, conv_cond_concat
from utils import get_image, imread, save_images
...
class DCGAN(object):
    def __init__(self, sess, input_height=64, input_width=256, crop=True,
                 batch_size=64, sample_num=64, output_height=64, output_width=256,
                 y_dim=None, z_dim=400, gf_dim=64, df_dim=64,
